        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div>
            <label className={labelClass} htmlFor="startDate">
              วันที่เริ่มต้นการประชุม <span className="text-destructive">*</span>
            </label>
            <input
              type="date"
              id="startDate"
          ...
          <div>
            <label className={labelClass} htmlFor="endDate">
              วันที่สิ้นสุดการประชุม <span className="text-destructive">*</span>
            </label>
            <input
              type="date"
              id="endDate"
          ...
          <div>
            <div className="flex items-center justify-between">
              <label className={labelClass} htmlFor="days">จำนวนวันประชุม (วัน)</label>
